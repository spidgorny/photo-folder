...
const getRow = <T extends Image = Image>(
	images: T[],
	{ containerWidth, rowHeight, margin }: Required<BuildLayoutOptions>,
...
const getRows = <T extends Image = Image>(
	images: T[],
	options: Required<BuildLayoutOptions>,
...
export const buildLayout = <T extends Image = Image>(
	images: T[],
	{ containerWidth, maxRows, rowHeight, margin }: Required<BuildLayoutOptions>,
): ImageExtendedRow<T>[] => {
